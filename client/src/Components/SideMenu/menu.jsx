...
function Menu() {
  ...
  return (
    <div id='menu'>
        <ul>
            <li style={{"--bgColor":'#57C5B6'}} color='#57C5B6' menu='daily' onClick={changeMenuSelected}>Bugün</li>
            ...
            <li style={{"--bgColor":'#95CD41'}} color='#95CD41' menu='archive' onClick={changeMenuSelected}>Arşiv</li>
            <hr />
